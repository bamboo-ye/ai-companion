...
func (s *Server) getOperatorConsoleBootstrap(w http.ResponseWriter, r *http.Request) {
	...
	capabilities := map[string]bool{
		...
		"manage_billing_quotas":      opsauth.Can(operator.Role, "admin"),
	...
	writeJSON(w, http.StatusOK, map[string]any{
		...
		"sections": []map[string]any{
			...
			{"key": "configuration", "label": "Configuration", "required_role": "viewer", "routes": []string{"/v1/ops/configuration/convergence", "/v1/ops/billing/plans", "/v1/ops/billing/quotas", "/v1/ops/billing/users/{user_id}/quotas", "/v1/ops/billing/users/{user_id}/usage", "/v1/ops/billing/users/{user_id}/adjustments", "/v1/ops/model-profiles", "/v1/ops/model/catalog"}},
